...
public class IsoscelesTrapezoid extends Shape {
    ...
    public static Shape fromBasesAndLeg(double baseA, double baseB, double leg) {
    ...
    public static Shape fromBaseAndHeightAndArea(double baseA, double height, double area) {
        double baseB = (2 * area) / height - baseA;
        return IsoscelesTrapezoid.fromBasesAndHeight(baseA, baseB, height);
    }

    public static Shape fromBaseAndLegAndArea(double baseA, double leg, double area) {
        return null;
    }

    public static Shape fromHeightAndLegAndArea(double height, double leg, double area) {
